...
const h1 = ({ children }: INodeWithChildren) => (
  <h1 className="my-5 text-3xl font-bold text-primary-700">{children}</h1>
);

const h2 = ({ children }: INodeWithChildren) => (
  <h2 className="my-5 mt-9 text-2xl font-semibold text-primary-700">
    {children}
  </h2>
);

const h3 = ({ children }: INodeWithChildren) => (
  <h3 className="text-grey-700 my-4 font-semibold">{children}</h3>
);

const h4 = ({ children }: INodeWithChildren) => (
  <h4 className="my-4 text-lg font-semibold text-primary-700">{children}</h4>
);
...
const ul = ({ children }: INodeWithChildren) => (
  <ul className="my-3 list-disc pl-5 text-gray-700">{children}</ul>
);

const ol = ({ children }: INodeWithChildren) => (
  <ol className="my-3 list-decimal pl-5 text-gray-700">{children}</ol>
);
